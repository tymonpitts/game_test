...
def init():
    ...
    shaders = {}
    shaders['skin'] = core.Shader(vert_shaders['skin'], frag_shaders['frag'])
    ...
    shaders['point'] = core.Shader(vert_shaders['point'], frag_shaders['frag'])
    ...
    shaders['constant'] = core.Shader(vert_shaders['constant'], frag_shaders['frag'])
    ...
    shaders['heightmap'] = core.Shader(vert_shaders['heightmap'], frag_shaders['heightmap'])
